      ...
      <Paper sx={{ mb: 2, p: 2 }}>
        ...
        <Box display={{ xs: 'flex', sm: 'none' }} alignItems="center" gap={1} mb={1}>
          <FormControlLabel
            ...
            sx={{ '& .MuiFormControlLabel-label': { fontSize: { xs: '11px' } } }}
          />
          <FormControlLabel
        ...
        <TableContainer sx={{ overflowX: 'auto' }}>
          <Table size="small" sx={{ tableLayout: 'fixed', minWidth: { xs: 900, sm: 1000 } }}>
            <TableHead>
              <TableRow>
                <TableCell sx={{ width: { xs: 112, sm: 140 }, pr: 1, fontSize: { xs: '14px', sm: '18px' }, fontWeight: 'bold', py: { xs: 0.5, sm: 1 }, px: { xs: 0.5, sm: 1.5 } }}>
                  <TableSortLabel
                ...
                <TableCell sx={{ width: { xs: 240, sm: '22%' }, fontSize: { xs: '14px', sm: '18px' }, fontWeight: 'bold', py: { xs: 0.5, sm: 1 }, px: { xs: 0.5, sm: 1.5 }, display: showClientColumn ? 'table-cell' : { xs: 'none', sm: 'table-cell' } }}>
                  <TableSortLabel
                ...
                <TableCell sx={{ width: { xs: 360, sm: '38%' }, fontSize: { xs: '14px', sm: '18px' }, fontWeight: 'bold', py: { xs: 0.5, sm: 1 }, px: { xs: 0.5, sm: 1.5 }, display: showAddressColumn ? 'table-cell' : { xs: 'none', sm: 'table-cell' } }}>
                  <TableSortLabel
                ...
                <TableCell sx={{ width: { xs: 96, sm: 120 }, fontSize: { xs: '14px', sm: '18px' }, fontWeight: 'bold', py: { xs: 0.5, sm: 1 }, px: { xs: 0.5, sm: 1.5 } }}>
                  <TableSortLabel
                ...
                <TableCell sx={{ width: { xs: 120, sm: 140 }, fontSize: { xs: '14px', sm: '18px' }, fontWeight: 'bold', py: { xs: 0.5, sm: 1 }, px: { xs: 0.5, sm: 1.5 } }}>
                  <TableSortLabel
                ...
                <TableCell sx={{ width: { xs: 96, sm: 120 }, fontSize: { xs: '14px', sm: '18px' }, fontWeight: 'bold', py: { xs: 0.5, sm: 1 }, px: { xs: 0.5, sm: 1.5 } }}>
                 ...
                 <TableCell sx={{ whiteSpace: 'nowrap', width: { xs: 120, sm: 140 }, fontSize: { xs: '14px', sm: '18px' }, fontWeight: 'bold', py: { xs: 0.5, sm: 1 }, px: { xs: 0.5, sm: 1.5 }, textAlign: 'left' }}>Действия</TableCell>
              </TableRow>
            </TableHead>
            <TableBody>
              {filteredInvoices.length === 0 ? (
                <TableRow>
                  <TableCell sx={{ fontSize: { xs: '14px', sm: '18px' }, py: { xs: 0.5, sm: 1 }, px: { xs: 0.5, sm: 1.5 } }} colSpan={7} align="center">Нет данных</TableCell>
                </TableRow>
              ) : (
                pagedInvoices.map(inv => (
                  <TableRow key={inv?.uid || Math.random()} hover selected={selectedInvoice?.uid === inv?.uid} onClick={() => inv && setSelectedInvoice(inv)} style={{ cursor: 'pointer' }}>
                    <TableCell sx={{ width: { xs: 112, sm: 140 }, pr: 1, fontSize: { xs: '14px', sm: '18px' }, py: { xs: 0.5, sm: 1 }, px: { xs: 0.5, sm: 1.5 } }}>
                    ...
                    <TableCell sx={{ width: { xs: 240, sm: '22%' }, fontSize: { xs: '14px', sm: '18px' }, py: { xs: 0.5, sm: 1 }, px: { xs: 0.5, sm: 1.5 }, display: showClientColumn ? 'table-cell' : { xs: 'none', sm: 'table-cell' }, whiteSpace: 'normal', wordBreak: 'break-word' }}>{inv?.clientName}</TableCell>
                    <TableCell sx={{ width: { xs: 360, sm: '38%' }, fontSize: { xs: '14px', sm: '18px' }, py: { xs: 0.5, sm: 1 }, px: { xs: 0.5, sm: 1.5 }, display: showAddressColumn ? 'table-cell' : { xs: 'none', sm: 'table-cell' }, whiteSpace: 'normal', wordBreak: 'break-word' }}>{inv?.deliveryAddress ?? ''}</TableCell>
                    <TableCell sx={{ width: { xs: 96, sm: 120 }, fontSize: { xs: '14px', sm: '18px' }, py: { xs: 0.5, sm: 1 }, px: { xs: 0.5, sm: 1.5 } }}>{inv?.docDate ? new Date(inv.docDate).toLocaleDateString('ru-RU') : ''}</TableCell>
                    <TableCell sx={{ width: { xs: 120, sm: 140 }, fontSize: { xs: '14px', sm: '18px' }, py: { xs: 0.5, sm: 1 }, px: { xs: 0.5, sm: 1.5 } }}>{typeof inv?.sumSNds === 'number' ? inv.sumSNds.toLocaleString('ru-RU', { style: 'currency', currency: 'RUB' }) : ''}</TableCell>
                    <TableCell sx={{ width: { xs: 96, sm: 120 }, fontSize: { xs: '14px', sm: '18px' }, py: { xs: 0.5, sm: 1 }, px: { xs: 0.5, sm: 1.5 } }}>
                      {inv?.status ? (
                        <Chip label={inv.status} color={inv.status === 'Не подтвержден' ? 'error' : 'success'} size="small" />
                      ) : ''}
                    </TableCell>
                    <TableCell sx={{ whiteSpace: 'nowrap', width: { xs: 120, sm: 140 }, fontSize: { xs: '14px', sm: '18px' }, py: { xs: 0.5, sm: 1 }, px: { xs: 0.5, sm: 1.5 }, textAlign: 'right' }}>
